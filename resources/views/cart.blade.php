                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        <a href="#">
                                            <img src="{{asset($cart->model->image)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                        </a>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                        <a href="{{route('cart.decr',['id'=>$cart->rowId, 'qty'=>$cart->qty])}}" class="quantity-minus">-</a>
                                        <input title="Qty" class="email input-text qty text" type="text" placeholder="1" value="{{$cart->qty}}" readonly>
                                        <a href="{{route('cart.incr',['id'=>$cart->rowId, 'qty'=>$cart->qty])}}" class="quantity-plus">+</a>
                                    </div>
